 ...
 * @see Creature
 */
public class Pokey extends Creature
{
	...
	static
	{
		IMAGE = Toolkit.getDefaultToolkit().getImage("img/creatures/pokey.png");
	}
	 ...
	 */
	public Pokey(long santeMax, int nbPiecesDOr, double vitesse)
	{
	 ...
	 * @param vitesse vitesse de la creature
	 */
	public Pokey(int x, int y, long santeMax, int nbPiecesDOr, double vitesse)
	{
	...
	{
		return new Pokey(x,y,getSanteMax(),getNbPiecesDOr(),getVitesseNormale());
	}
}
