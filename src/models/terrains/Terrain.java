 ...
 * 
 * Cette classe est abstraite, elle ne peut pas etre instanciee en tant que telle
 * mais doit etre heritee. 
 * <p>
 * Cette classe contient tous les elements contenu sur le terrain, c'est a dire :<br>
 * - Les tours<br>
 * - Les creatures<br>
 * - Le maillage<br>
...
public abstract class Terrain
{
	 ...
	 * certaines zones. Les creatures ne peuvent egalement pas si rendre.
	 ...
	 * @see Maillage
	 */
	private final int PRECISION_MAILLAGE = 10; // espace entre deux noeuds en pixels
	private final Maillage maillage;
	
	/**
	 * Zones de depart et d'arrivee des creatures. 
	 * Les creatures sont implentees aleatoirement dans la zone de départ
	 * lorsqu'une vague des creatures est sollicitee par le joueur. Ces dernieres 
	 * doivent alors ce rendre dans la zone d'arrivee en utilisant le chemin le 
	 * plus cour fourni par le maillage.
	 */
	...
	/**
	 * Permet de savoir si une tour peut etre posee a un certain endroit
	 * sur le terrain.
	 * 
	...
	/**
	 * Permet de recuperer le chemin le plus court entre deux points
	 * sur le terrain. 
	 * 
