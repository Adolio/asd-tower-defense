 ...
 * @see Creature
 */
public class Boo extends Creature
{
	...
	static
	{
		IMAGE = Toolkit.getDefaultToolkit().getImage("img/creatures/boo.png");
	}
	...
	{
		return new Boo(x,y,getSanteMax(),getNbPiecesDOr(),getVitesseNormale());
	}
}
