...
public abstract class Tour extends Rectangle implements Runnable
{
	...
	/**
	 * coefficient de prix de vente de la tour.
	 * utilisee pour calculer le prix de vente de la tour.
	 */
	...
	/**
	 * la tour gere sont propre thread qui s'occupe de trouver une creature
	 ...
	 * 
	 * @param x la position sur l'axe X de la tour
	 * @param y la position sur l'axe Y de la tour
	 * @param largeur la largeur de la tour
	 * @param hauteur la hauteur de la tour
	 * @param couleurDeFond la couleur de fon de la tour
	 * @param nom le nom de la tour
	 * @param prixAchat le prix d'achat de la tour
	 */
	...
	/**
	 * methode a redefinir qui prend les decision concernant les tires
	 * de la tour.
	 */
	 ...
	 * @param terrain le terrain sur lequel la tour est posee
	 */
	...
	/**
	 * Permet de mettre la tour en jeu.
	 * Cette methode demarre le thread de la tour.
	 * Des lors, elle tirera sur les creatures.
	 */
	 ...
	 * @return la creature la plus proche et a portee de la tour 
	 * 		   ou <b>null s'il n'y a pas de creature a portee</b>
	 */
