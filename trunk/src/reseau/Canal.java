...
/**
 * Cette classe implémente un canal de transmission sur lequel on peut envoyer diverses
 * données ainsi qu'en lire.
 * 
...
public class Canal {
   ...
   // Pour savoir si on affiche les messages de debug dans la console (pratique...).
   private boolean afficherMessagesDebug = false;
   
   /**
    * L'appelant de ce constructeur veut attendre des connexions entrantes sur le port
    * donné en paramètre ou sinon chercher une connexion qui est déjà en attente.
    * Ce constructeur ne se termine pas tant qu'une connexion n'est pas établie.
    * Si un problème survient, une exception de type CanalException est levée.
    * Il s'agit alors d'une erreur fatale et le programme devrait se terminer.
    * 
    * @param port Le port associé à ce côté du canal
    * @param afficherMessagesDebug Pour afficher ou non les messages de debug en console
    * @throws CanalException Si un problème de connexion survient
    */
   public Canal(Port port, boolean afficherMessagesDebug) throws CanalException {
      ...
      try {
         ...
         // Configurer les flux entrant/sortant pour la lecture et l'écriture sur le
   ...
   /**
    * Ce constructeur permet à son appelant de se connecter à l'adresse IP donnée et sur
    * le port donnés en paramètres. Cela attendra que l'autre côté du canal réponde.
    * Si la connexion est refusée, une exception java.net.ConnectException est levée.
    * Ce n'est cependant pas une erreur fatale, et le programme peut tout aussi bien
    * continuer si cette denière est catchée. Si la connexion ne peut être établie pour
    * une raison quelconque, une exception de type CanalException est levée. Cette fois,
    * il s'agit d'une erreur fatale et le programme devrait être interrompu.
    * 
    * @param adresseIp L'adresse IP vers laquelle on veut créer un canal
    * @param numeroPort Le numéro de port de l'adresse IP
    * @param afficherMessagesDebug Si on veut afficher les messages de debug
    * @throws ConnectException Si la connexion est refusée à cette IP + Port
    * @throws CanalException Si une erreur de connexion survient
    */
   public Canal(String adresseIp, int numeroPort, boolean afficherMessagesDebug)
      ...
      try {
         ...
         // La connexion a été refusée. Pas considéré comme une erreur fatale.
         if (afficherMessagesDebug) {
            System.out.println("     Canal: connexion refusée");
         }
         throw e;
      } catch (Exception e) {
         // Un problème de connexion est survenu. Considéré comme une erreur fatale.
         System.out
   ...
   /**
    * Cette méthode est appelée quand une socket a été établie entre les 2 extrémités
    * connectées. Elle configure les flux d'entrée/sortie pour le canal courant. Si un
    * problème est rencontré, une exception de type CanalException est levée.
    * 
    * @throws CanalException Si un problème de flux survient.
    */
   public void configurerFlux() throws CanalException {
      try {
         ...
         // Nous voulons écrire toutes sortes d'informations sur le canal. Le filtre le
         // plus approprié est donc Object.
         // On crée d'abord le flux de sortie puis on le flush() avant de créer le flux
         // d'entrée, sinon le constructeur du flux d'entrée peut bloquer (voir la doc
         // de l'API pour plus d'infos). Cela ne convient qu'aux flux d'objets, et non
         // aux flux de données (Data Streams).
         // Il ne faut enfin pas oublier d'envoyer des objets sur le flux de sortie qui
   ...
   /**
    * Cette méthode envoie un message sur le canal de transmission sous forme de String.
    * 
    * @param message Le String à envoyer.
    * @throws CanalException Si un problème de transmission survient.
    */
   public void envoyerString(String message) throws CanalException {
      ...
      try {
         ...
         // Ne pas oublier de vider le flux de sortie après avoir écrit dessus!
         canalOut.flush();
      }
      catch (Exception e) {
         System.out
   ...
   /**
    * Cette méthode permet d'attendre de recevoir un message de type String venant du
    * canal de transmission.
    * 
    * @return
   ...
   /**
    * Cette méthode envoie un message sur le canal de transmission sous forme de int.
    * 
    * @param i
    * @throws CanalException
    */
   ...
   /**
    * Cette méthode permet d'attendre de recevoir un message de type int venant du
    * canal de transmission.
    * 
    * @return
    * @throws CanalException
   ...
   /**
    * Cette méthode envoie un message sur le canal de transmission sous forme de double.
    * 
    * @param d
    * @throws CanalException
    */
   ...
   /**
    * Cette méthode permet d'attendre de recevoir un message de type double venant du
    * canal de transmission.
    * 
    * @return
    * @throws CanalException
   ...
   /**
    * Cette méthode envoie un message sur le canal de transmission sous forme de tableau
    * de bytes.
    * 
    * @param b
    * @throws CanalException
   ...
   /**
    * Cette méthode permet d'attendre de recevoir un message de type tableau de bytes
   ...
   /**
    * Cette méthode envoie un message sur le canal de transmission sous forme de Paquet
    * (objet de la classe Paquet).
    * 
    * @param p
    * @throws CanalException
    */
   ...
   /**
    * Cette méthode permet d'attendre de recevoir un message de type Paquet (objet de la
    * classe Paquet) venant du canal de transmission.
    * 
    * @return
    * @throws CanalException
    */
   ...
   /**
    * TODO :
    * Ajouter des méthodes pour envoyer des objets sérializés quelconques.
    */
   ...
   /**
    * Cette méthode permet de fermer correctement le canal en fermant les flux d'entrée/
    * sortie ainsi que les deux sockets de chaque côté du canal.
    * 
    * @throws CanalException Si un problème de fermeture des flux/Sockets survient.
    */
